...
@section('content')
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
                                            ...
                                            <div class="breadcomb-ctn">
                                                <h2>Dashboard </h2>
                                                <p>Welcome to priceOye <span class="bread-ntd">Admin Dashboard</span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        ...
        <div class="charts-area mg-tb-15">
            <div class="container-fluid">
                <div class="row">
                    <strong class="text-white text-center">Bar Chart</strong>
                    <div class="col-lg-11 " id="chart">
...
<script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <script>
            <?php
            $category = DB::table('categories')->select('c_name')->get();
                    
            $product = "";
            foreach ($category as $row) {
                $mix =    DB::table('categories')
                    ->join('products', 'categories.id', 'products.category_id')
                    ->select('categories.*', 'products.*')
                    ->where('categories.c_name', $row->c_name)
                    ->count(); 
            ...
            var options = {
                ...
                xaxis: {
                  categories: [<?php foreach($category as $row){ ?>' <?php echo $row->c_name; ?> ', <?php } ?> ], 
