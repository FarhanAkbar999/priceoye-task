                ...
                <div class="product-status-wrap">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>{{ $row->c_name  }}</td>
                            <td>
                                <a href="{{ route('categories.edit',$row->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>Edit</a>
                                

                                <form class="d-inline" method="POST" action="{{ route ('categories.destroy',$row->id ) }}" accept-charset="UTF-8">
                                    @method('DELETE')
                                    @csrf
