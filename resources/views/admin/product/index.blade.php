            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><img src="{{ asset('uploads/products/'. $row->image) }}" alt="" /></td>
                            <td>{{ $row->name  }}</td>
                            <!-- <td>
                            ...
                            <td>
                                <a href="{{ route('products.edit',$row->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>Edit</a>
                                

                                <form class="d-inline" method="POST" action="{{ route ('products.destroy',$row->id ) }}" accept-charset="UTF-8">
                                    @method('DELETE')
                                    @csrf
