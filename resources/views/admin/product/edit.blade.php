                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Edit Product  </h2>
                                        <p>Welcome to priceOye <span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="review-tab-pro-inner">
                        ...
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            <div class="product-tab-list tab-pane fade active in" id="description">
                            	<form method="POST" action="{{ route ('products.update', $product->id) }}" enctype="multipart/form-data" accept-charset="UTF-8">
                        		@method('PUT')
                        		@csrf
	                                <div class="row">
	                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                                        <div class="review-content-section">
	                                            ...
	                                            <div class="input-group mg-b-pro-edt">
	                                                <span class="input-group-addon"></span>
	                                                <input type="number" class="form-control" placeholder=" Product sPrice" name="price" min="0" value="{{ $product->price }}">
	                                            </div>
                                                ...
                                                <img src="{{ asset('uploads/products/'.$product->image) }}" style="height:100px; margin-bottom: 1.5rem;">
	                                            ...
	                                            <select name="category_id" class="form-control pro-edt-select form-control-primary ">
													...
													@foreach($category as $row)
														...
														<option value="{{ $row->id }}" <?php if($product->category_id == $row->id){ echo "selected";} ?>>{{ $row->c_name }}
										            	</option>
													@endforeach
												</select>
	                                        </div>
	                                    ...
	                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                                        <div class="review-content-section">
	                                            <div class="input-group mg-b-pro-edt">
	                                                ...
	                                                <textarea id="short_description" placeholder="short_description" class="form-control" name="short_description" cols="50" rows="3">{{ $product->short_description }}</textarea>
	                                            </div>

	                                            <div class="input-group mg-b-pro-edt">
	                                                <span class="input-group-addon"></span>
	                                                
	                                                <textarea id="description" placeholder="description" class="form-control" name="description" cols="50" rows="3">{{ $product->description }}</textarea>
	                                            </div>
	                                            ...
	                                            <select name="status" class="form-control pro-edt-select form-control-primary">
													...
													<option value="2" <?php if($product->status == 2){ echo "selected";} ?>>Disable</option>
